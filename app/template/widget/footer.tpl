<footer id="footer" class="m-footer clearfix">
    <div class="footer-inner clearfix">
        <div class="logo">
            <i class="common-icons-footer-logo"></i>
        </div>
        <ul class="detail">
            <li>
                <ul class="nav">
            ...
            <li class="media">
                <div>私信有印<i class="common-icons-email"></i></div>
                <div>关注有印<i class="common-icons-weixin"></i><i class="common-icons-instagram"></i><i class="common-icons-weibo"></i><i class="common-icons-douban"></i></div>
            </li>
            <li class="qualify">京ICP备14008353号-1 \ 京公网安备12010802014108号 \ Powered by 北京领结科技有限公司</li>
        </ul>
    </div>
</footer>